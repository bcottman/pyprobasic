...
### un-supervised clustering metrics
...
class NameToClass:
    """
        map package name to class stub
    """
    ...
    _metrics_ = {
        ...
        # cluster Type metric_name
        #        metric_func_name: metric_func_
        ## from sklearn.metrics
        "UnsupervisedClustering": {
            "silhouette": silhouette_score,
            "calinski_harabaz_": calinski_harabaz_score,
